...
model_param.P = diag([1,1,1,1,1,1]);
model_param.Q = diag([1,1,1,1,1,1]);
model_param.R = diag([1,1,1,1]);
model_param.x0 = [0;1;1;1;1;1]; 
model_param.umin = [-5;-5;-5;-5];
model_param.umax = [5;5;5;5];
%set Model
