    ...
    methods
        ...
        function compute_sensitivities(obj)
            ...
            for j = 1:length(obj.neighbors)
                ...
                cur_neighbor.gji_x = [cur_neighbor.gji_x, sensi_coupling.dlij_dxj(x_j(k,:),x_i(k,:)) ...
                        +  sensi_coupling.dfij_dxj(x_j(k,:),x_i(k,:))' * lambda_j(k,:)']; % cur_neighbor.gji_x 3x21
                end 
            end
        end
%%
...
%%
        ...
        function lambda_dot = dHi_dxi(obj,t,x_r,lambda_i,t_span)
            ...
            for j = 1:length(obj.neighbors)
                ...
                % x_ij = interp1(t_span',obj.x_ijref,t)';
...
%%
        function solve_localOCP(obj)
            ...
            for r=1:obj.opt_param.fixed_iter_j
                ...
                if r == 1
                    obj.collect_first = [obj.collect_first,x_r];
                end
            ...
            obj.collect_last = [obj.collect_last,x_r];
            
            % update the output
            u_r = zeros(size(obj.u_q,1),2);
