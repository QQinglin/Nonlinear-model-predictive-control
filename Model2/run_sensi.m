...
%% draw
    ...
    data_eva = [data_eva, delta_kx]; % **************
     writematrix(data_eva, 'C:\Users\24966\Desktop\project\2eva.csv'); % *********************
    ...
    for i = 1:num_agents
        ...
        writematrix(data_xq, 'C:\Users\24966\Desktop\project\2Sen_x_q.csv'); % *********************
        title('Sensi x_i ');
        xlabel('Time');
    ...
    for i = 1:num_agents
        ...
        hold on;
         ...
         writematrix(data_lambdaq, 'C:\Users\24966\Desktop\project\2Sen_lambda_q.csv'); % *********************
    ...
    for i = 1:num_agents
        ...
        hold on;
         ...
         writematrix(data_uq, 'C:\Users\24966\Desktop\project\2Sen_u_q.csv'); % *********************
        title('Sensi u_i ');
        xlabel('Time');
        ylabel('State Variables');
        legend('u_1', 'u_2','u_3');    
