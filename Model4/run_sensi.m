...
%% draw
    ...
    writematrix(data_eva, 'C:\Users\24966\Desktop\project\4eva.csv'); % *********************
    ...
    for i = 1:num_agents
        ...
        writematrix(data_xq, 'C:\Users\24966\Desktop\project\4Sen_x_q.csv'); % *********************
        title('Sensi x_i ');
        xlabel('Time');
    ...
    for i = 1:num_agents
        ...
        writematrix(data_lambdaq, 'C:\Users\24966\Desktop\project\4Sen_lambda_q.csv'); % *********************
    ...
    for i = 1:num_agents
        ...
        writematrix(data_uq, 'C:\Users\24966\Desktop\project\4Sen_u_q.csv'); % *********************
        title('Sensi u_i ');
        xlabel('Time');
        ylabel('State Variables');
        legend('u_1', 'u_2','u_3');    
