...
opt_param.T = 4;                                      % Prediction horizon
...
agent_model_4 = agentModel_4(agentModel_param);
agent_model_5 = agentModel_5(agentModel_param);
...
coupling_model_2_5 = couplingModel_2_5(couplingModel_param);
coupling_model_3_2 = couplingModel_3_2(couplingModel_param);
coupling_model_3_4 = couplingModel_3_4(couplingModel_param);
coupling_model_4_3 = couplingModel_4_3(couplingModel_param);
coupling_model_4_5 = couplingModel_4_5(couplingModel_param);
coupling_model_5_2 = couplingModel_5_2(couplingModel_param);
coupling_model_5_4 = couplingModel_5_4(couplingModel_param);

% Define Coupling Graph, adjecency matrix with couplings
opt_param.A = {[],coupling_model_1_2,[],[],[];
               coupling_model_2_1,[],coupling_model_2_3,[],coupling_model_2_5;
               [],coupling_model_3_2,[],coupling_model_3_4,[];
               [],[],coupling_model_4_3,[],coupling_model_4_5;
               [],coupling_model_5_2,[],coupling_model_5_4,[]};  
...
agent_id = 4;
agentModel_4 = Agent(opt_param,agent_model_4,agent_id); 
agent_id = 5;
agentModel_5 = Agent(opt_param,agent_model_5,agent_id); 
agents = {agentModel_1,agentModel_2,agentModel_3,agentModel_4,agentModel_5};

%% Solve Central OCP
%Central model parameters
model_param.P = diag([1,1,1,1,1]);
model_param.Q = diag([1,1,1,1,1]);
model_param.R = diag([1,1,1,1,1]);
model_param.x0 = [1;1;1;1;1]; 
model_param.umin = [-5;-5;-5;-5;-5];
model_param.umax = [5;5;5;5;5];
%set Model
